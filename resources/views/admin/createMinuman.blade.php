...
<div class="max-w-2xl mx-auto py-10 px-4">
    ...
    <div class="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
        <div>
            <h1 class="text-3xl font-extrabold text-gray-800 font-title">Tambah Minuman Baru</h1>
            <p class="text-sm text-gray-500 mt-0.5">Lengkapi form di bawah untuk mendaftarkan menu minuman baru</p>
        </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.minumanstore') }}" enctype="multipart/form-data" class="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm space-y-6">
        @csrf
        ...
        <div class="space-y-1.5">
            ...
            <input type="text" name="nama_minuman" id="nama_minuman" placeholder="Contoh: Es Teh Manis Segar" required
        ...
        <div class="space-y-1.5">
            ...
            <textarea name="deskripsi" id="deskripsi" rows="4" placeholder="Tuliskan cita rasa, penyajian dingin/hangat, atau porsi hidangan minuman ini..." required
        ...
        <div class="grid sm:grid-cols-2 gap-6">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price" id="price" placeholder="Contoh: 15000" min="0" required
        ...
        <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full text-xs font-bold shadow-md hover:shadow-lg transition">Simpan Minuman</button>
        </div>
    </form>
</div>
